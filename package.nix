...
let
  ...
  platformHashes = {
    "x86_64-linux" = "sha256-j11h+WxH1rx6c4Qn8b6VQRT9OA9x7dSIEdiDjm3XOtE=";
    "aarch64-linux" = "sha256-DlatEaTz5akC0UzVVUIJi3wwlzBvGb+zfPAU4zhXAas=";
    "x86_64-darwin" = "sha256-pCspvQ0zg/Ovp2sl7Cv8wOQBZHRUoznFocn0NhpzTwc=";
    "aarch64-darwin" = "sha256-en9Z8jBUFQzlvm+ZLrZX5WwkaS17d+dsdIAcB6zoJVI=";
    "x86_64-windows" = "sha256-FiW2fmO67nJdnxNmrQCQIvih5NYDlPKSKy8ewzLq3WY=";
  };
...
stdenv.mkDerivation rec {
  pname = "opencode";
  version = "1.14.26";  # Update this to install a newer version
